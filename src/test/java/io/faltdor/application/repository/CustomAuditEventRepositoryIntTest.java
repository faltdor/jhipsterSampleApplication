package io.faltdor.application.repository;

import io.faltdor.application.JhipsterSampleApplicationApp;
import io.faltdor.application.config.Constants;
import io.faltdor.application.config.audit.AuditEventConverter;
import io.faltdor.application.domain.PersistentAuditEvent;
...
import static io.faltdor.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
