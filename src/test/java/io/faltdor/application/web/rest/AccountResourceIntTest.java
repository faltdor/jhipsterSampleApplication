package io.faltdor.application.web.rest;

import io.faltdor.application.config.Constants;
import io.faltdor.application.JhipsterSampleApplicationApp;
import io.faltdor.application.domain.Authority;
import io.faltdor.application.domain.User;
import io.faltdor.application.repository.AuthorityRepository;
import io.faltdor.application.repository.UserRepository;
import io.faltdor.application.security.AuthoritiesConstants;
import io.faltdor.application.service.MailService;
import io.faltdor.application.service.dto.UserDTO;
import io.faltdor.application.web.rest.errors.ExceptionTranslator;
import io.faltdor.application.web.rest.vm.KeyAndPasswordVM;
import io.faltdor.application.web.rest.vm.ManagedUserVM;
import io.faltdor.application.service.UserService;
